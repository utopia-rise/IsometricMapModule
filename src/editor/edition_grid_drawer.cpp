...
void editor::EditionGridDrawer::draw_plane(const editor::EditorPlane& p_editor_plane, const node::IsometricMap* map) {
    ...
    switch (p_editor_plane.get_axis()) {
        case Vector3::AXIS_X: {
            ...
            polygon_points.push_back({-diamond_width * 0.5f * map_size.y, diamond_height * 0.5f * map_size.y - tile_z_length * map_size.z});
        ...
        case Vector3::AXIS_Y: {
            ...
            polygon_points.push_back({diamond_width * 0.5f * (map_size.x), diamond_height * 0.5f * map_size.x - tile_z_length * map_size.z});
            polygon_points.push_back({0, -tile_z_length * map_size.z});
            polygon_points.push_back({0, 0});
            break;
        case Vector3::AXIS_Z: {
            ...
            polygon_points.push_back({0, 0});
            polygon_points.push_back({-diamond_width * 0.5f * map_size.y, diamond_height * 0.5f * map_size.y});
            polygon_points.push_back({diamond_width * 0.5f * (map_size.x - map_size.y), diamond_height * 0.5f * (map_size.y + map_size.x)});
            polygon_points.push_back({diamond_width * 0.5f * map_size.x, diamond_height * 0.5f * map_size.x});
            polygon_points.push_back({0, 0});
            break;
    }
