...
PositionableSet::PositionableSet() :
    Resource(), identifier_to_scene_path(), identifier_to_loaded_scene(), is_loaded(false)
#ifdef TOOLS_ENABLED
    ,
    categories(), categories_to_identifiers(), last_id()
#endif
{
}
...
void PositionableSet::_bind_methods() {
    ...
    ADD_PROPERTY(PropertyInfo(Variant::DICTIONARY, "categories_to_identifiers", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NOEDITOR | PROPERTY_USAGE_INTERNAL),
    ...
    ADD_PROPERTY(
            PropertyInfo(Variant::INT, "last_id", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NOEDITOR | PROPERTY_USAGE_INTERNAL), "_set_last_id", "_get_last_id");
    ...
    ADD_PROPERTY(PropertyInfo(Variant::DICTIONARY, "identifier_to_scene_path", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NOEDITOR | PROPERTY_USAGE_INTERNAL),
