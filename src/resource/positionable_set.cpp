...
Map<int, String> PositionableSet::get_scene_paths_for_category(const String& p_group) const {
    if (!categories_to_identifiers.has(p_group)) {
        return {};
    }
...
void PositionableSet::insert_positionable_if_not_present(const String& category, const String& resource_path) {
    ...
    if (!categories_to_identifiers.has(category_hash)) {
        categories_to_identifiers[category_hash] = Vector<int>();
    }
...
void PositionableSet::_bind_methods() {
    ...
    ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "categories", PROPERTY_HINT_NONE, "",
                              PROPERTY_USAGE_NOEDITOR | PROPERTY_USAGE_INTERNAL), "set_categories",
                 "get_categories");
    ADD_PROPERTY_DEFAULT("categories", PoolStringArray());

    ClassDB::bind_method(D_METHOD("_set_categories_to_identifiers", "p_categories_to_identifiers"),
                         &PositionableSet::_set_categories_to_identifiers);
    ClassDB::bind_method(D_METHOD("_get_categories_to_identifiers"), &PositionableSet::_get_categories_to_identifiers);
    ADD_PROPERTY(PropertyInfo(Variant::DICTIONARY, "categories_to_identifiers", PROPERTY_HINT_NONE, "",
                              PROPERTY_USAGE_NOEDITOR | PROPERTY_USAGE_INTERNAL), "_set_categories_to_identifiers",
