...
bool IsometricConfiguration::do_iso_elements_overlap(const data::IsometricPositionableData* data1,
...
IsometricConfiguration::Hexagone
IsometricConfiguration::get_hexagone_2D_coordinates(const data::IsometricPositionableData* data) const {
