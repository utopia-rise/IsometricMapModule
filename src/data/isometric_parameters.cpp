...
IsometricParameters::IsometricParameters(int p_tile_width, int p_angle, float p_topological_margin) :
    diamond_width {p_tile_width}, topological_margin {p_topological_margin}, diamond_height {calculate_tile_height(p_tile_width, p_angle)},
    z_length {calculate_ez(p_tile_width, p_angle)}, z_ratio {z_length / static_cast<float>(diamond_height)} {}
